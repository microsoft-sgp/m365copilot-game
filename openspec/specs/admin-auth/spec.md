...
- **THEN** the rendered content MUST NOT include provider secrets, connection strings, raw telemetry fields, JWTs, OTP hashes, or unrelated dynamic values that are not required for the recipient to complete the OTP challenge
