# student-ambassador-referrals

## Purpose

Defines Student Ambassador referral code cataloging and optional player attribution during onboarding, kept separate from gameplay scoring and leaderboard rank calculation.
