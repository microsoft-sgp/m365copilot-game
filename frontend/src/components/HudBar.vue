...
const { clearedCount, linesWon, keywordCount, boardProgress } = useBingoGame();
...
<template>
  <div class="glass mb-4 flex flex-wrap gap-5 rounded-[14px] px-[18px] py-3.5">
    ...
    <div class="flex min-w-[160px] flex-1 flex-col justify-center gap-1">
      ...
      <div class="progress-track">
        <div class="progress-fill" :style="{ width: boardProgress + '%' }" />
      </div>
