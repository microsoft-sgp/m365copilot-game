  ...
  <div>
    ...
    <div class="mb-5 rounded-[14px] border border-error/20 bg-error/5 p-5">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <button class="btn-danger px-3 py-1.5 text-[12px]" @click="doClear">Clear All Data</button>
      </div>
      <div v-if="clearResult" class="mt-2 text-[12px] text-success">
    ...
    <div class="rounded-[14px] border border-error/20 bg-error/5 p-5">
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <button class="btn-danger px-3 py-1.5 text-[12px]" @click="doReset">Reset Leaderboard</button>
      </div>
      <div v-if="resetResult" class="mt-2 text-[12px] text-success">
