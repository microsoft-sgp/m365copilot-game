...
<template>
  <div>
    ...
    <!-- Results -->
    <div
      v-if="players.length > 0 && !selectedPlayer"
    ...
    >
      ...
      <!-- Sessions -->
      <h4 class="mb-2 text-label-lg font-bold text-primary">
        Game Sessions
      </h4>
      <div
      ...
      >
        <table class="w-full border-collapse text-label-md">
          <thead>
            <tr>
              <th class="border-b border-themed px-2 py-1 text-left text-primary">
                Pack
              </th>
              <th class="border-b border-themed px-2 py-1 text-left text-primary">
                Tiles
          ...
          <tbody>
            <tr
              v-for="s in playerDetail.sessions"
              :key="s.id"
            >
      ...
      >
        <table class="w-full border-collapse text-label-md">
          ...
          <tbody>
            <tr
              v-for="s in playerDetail.submissions"
              :key="s.id"
            >
              <td class="border-b border-outline-variant px-2 py-1">
                {{ s.org }}
